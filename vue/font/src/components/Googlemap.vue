<template>
    ...
    <br/>
    <br/>
      <h2 class="h2-gateway-tricker">Gateway Tricker</h2>
      <!-- {{markers}} -->
...
export default {
    ...
    return {
      ...
      show: false,
      center: { lat: 13.821582, lng: 100.519540 },
      markers: [],
      places: [],
      data_test:null,
      currentPlace: null,
  ...
  mounted() {
    ...
    lookhistory(){
      ...
      datalog(m){
        ...
        axios
          .post("http://localhost:3020/gateway",{
            id:this.data_test
          })
          .then(response => {
            ...
            for(let i = 0; i < response.data.message.length ; i++){
              ...
              this.gatewayname_index.push(response.data.message[i].gateway_name)
      ...
      pullThelatlng(){
          axios
            .post("http://localhost:3020/trackgateway", {
